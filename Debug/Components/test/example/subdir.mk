...
../Components/test/example/example.cpp \
../Components/test/example/main.cpp 

OBJS += \
./Components/test/example/example-sm.o \
./Components/test/example/example.o \
./Components/test/example/main.o 

CPP_DEPS += \
./Components/test/example/example-sm.d \
./Components/test/example/example.d \
./Components/test/example/main.d 


# Each subdirectory must supply rules for building sources it contributes
Components/test/example/%.o: ../Components/test/example/%.cpp Components/test/example/subdir.mk
